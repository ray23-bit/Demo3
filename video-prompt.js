 class VideoPromptGenerator {
    ...
    initUI() {
        this.container.innerHTML = `
            ...
            <div class="section">
                ...
                <div class="input-group">
                    <label for="video-model">Video Model<br><small>(Model Video)</small></label>
                ...
                <div class="input-group">
                    <label for="video-dialog">Character Dialog (Optional)<br><small>(Percakapan Karakter)</small></label>
                    <textarea id="video-dialog" rows="3" placeholder="Enter character dialog/conversation script..."></textarea>
                </div>
            </div>
    ...
    generatePrompt() {
        ...
        const dialog = getValue('video-dialog');
        ...
        let prompt = `Create a ${style} style ${model} video of ${subject} ${action}. `;
        ...
        if (dialog) prompt += `Character dialog: "${dialog}". `;
