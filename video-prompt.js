...
<option value="fantasy">🐉 Fantasy Pack</option>
<option value="sci-fi">🚀 Sci-Fi Pack</option>
<option value="dreamcore">🌙 Dreamcore Pack</option>
<option value="vintage">📼 Vintage Pack</option>
<option value="music-video">🎵 Music Video Pack</option>
<option value="nature">🌲 Nature Documentary Pack</option>
<option value="sports">🏅 Sports Highlight Pack</option>
<option value="kpop">🎤 K-Pop MV Pack</option>
<option value="bollywood">💃 Bollywood Drama Pack</option>
<option value="arabic">🌙 Arabic Story Pack</option>
<option value="tiktok">📱 TikTok Vertical Pack</option>
<option value="reels">📽️ Instagram Reels Pack</option>
<option value="gaming">🎮 Gaming Highlight Pack</option>
...
<option value="horizontal 9:16">9:16 (horizontal)</option>
            ...
            <div class="output-group">
                ...
                <button class="clear-button" id="clear-video-prompt">
                    <i class="fas fa-eraser"></i> Clear Prompt<br><small>(Hapus Prompt)</small>
                </button>
        ...
        if (presetDropdown) {
            presetDropdown.addEventListener('change', (e) => {
                ...
                if (preset === 'cinematic') {
                    ...
                    apply('video-style', 'surreal');
                    apply('video-mood', 'whimsical');
                    apply('video-camera', 'over-the-shoulder');
                    apply('video-lighting', 'rim light');
                    apply('video-aspect', '16:9');
                    apply('video-fps', '30');
                    apply('video-resolution', '2K');
                } else if (preset === 'sci-fi') {
                    apply('video-style', 'retro-futurism');
                    apply('video-mood', 'intense');
                    apply('video-camera', 'tracking shot');
                    apply('video-lighting', 'volumetric');
                    apply('video-aspect', '21:9');
                    apply('video-fps', '60');
                    apply('video-resolution', '4K');
                } else if (preset === 'dreamcore') {
                    apply('video-style', 'dreamcore');
                    apply('video-mood', 'dreamy');
                    apply('video-camera', 'fish eye');
                    apply('video-lighting', 'soft');
                    apply('video-aspect', '1:1');
                    apply('video-fps', '30');
                    apply('video-resolution', '1080p');
                } else if (preset === 'vintage') {
                    apply('video-style', 'vintage');
                    apply('video-mood', 'nostalgic');
                    apply('video-camera', 'medium shot');
                    apply('video-lighting', 'natural');
                    apply('video-aspect', '4:3');
                    apply('video-fps', '24');
                    apply('video-resolution', '480p');
                } else if (preset === 'music-video') {
                    apply('video-style', 'vaporwave');
                    apply('video-mood', 'energetic');
                    apply('video-camera', 'low angle');
                    apply('video-lighting', 'neon');
                    apply('video-aspect', '16:9');
                    apply('video-fps', '60');
                    apply('video-resolution', '4K');
                    ...
                    apply('video-style', 'baroque');
                    apply('video-mood', 'mysterious');
                    apply('video-camera', 'over-the-shoulder');
                    apply('video-lighting', 'chiaroscuro');
                    apply('video-aspect', '16:9');
                    apply('video-fps', '30');
                    ...
                    apply('video-style', 'vaporwave');
                    apply('video-mood', 'uplifting');
                    apply('video-camera', 'close-up');
                    apply('video-lighting', 'neon');
                    apply('video-aspect', '9:16');
                    apply('video-fps', '60');
                    apply('video-resolution', '1080p');
                } else if (preset === 'reels') {
                    apply('video-style', 'minimalist');
                    apply('video-mood', 'inspirational');
                    apply('video-camera', 'medium shot');
                    apply('video-lighting', 'soft');
                    apply('video-aspect', '9:16');
                    apply('video-fps', '60');
